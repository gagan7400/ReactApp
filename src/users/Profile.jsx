const Profile = () => {
    const user = {
        ...
        age: 28,
        gender: 'Male',
        profile: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80',
                ...
                <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
                    ...
                    <div className="grid flex-1 gap-4 sm:grid-cols-2">
                        ...
                        <div className="rounded-xl border border-white/10 bg-slate-800/70 p-4">
                            ...
                            <p className="mt-1 text-base font-semibold text-white">{user.profile}</p>
                        </div>
                    </div>
                </div>
            </div>
